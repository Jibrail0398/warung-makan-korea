<template>
  <div class="upload-section">
    <div class="upload-heading"><div><h3>Bukti Transfer</h3></div></div>
    <label v-if="!previewUrl" class="upload-box" for="paymentProof">
      ...
      <strong>+ Upload Bukti</strong><small>JPG, PNG atau WebP (Maks 10MB)</small>
    </label>
    <div v-else class="preview-wrapper">
      <div class="preview-header"><div><strong>Bukti pembayaran</strong></div><button type="button" class="remove-upload" :disabled="isSubmitting" @click="removeFile">Remove</button></div>
