...
>
  ...
  />
            ...
            <nav class="profile-nav" aria-label="Profile navigation">
              <router-link class="profile-nav-item active" to="/profile">
                <span>Profile Information</span>
                <span aria-hidden="true">›</span>
              </router-link>

              <router-link class="profile-nav-item" to="/orders">
                <span>Change Phone Number</span>
                <span aria-hidden="true">›</span>
              </router-link>

              <router-link class="profile-nav-item" to="/change-password">
          ...
          <section class="profile-content" aria-label="Profile information">
            <ProfileForm
              :profile="profile"
              @save="handleSave"
            />
...
const handleSave = (updatedProfile) => {
  ...
  // await axios.put('/api/customer/profile', updatedProfile);
};
</script>
