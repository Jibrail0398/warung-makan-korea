  ...
  <div class="order-detail-page-wrap">
    ...
    <main class="order-detail-page"><div class="container">
      ...
      <template v-else>
        ...
        <section class="receipt-panel"><div><p class="panel-kicker">Struk digital</p><h2>Ringkasan pesanan siap diunduh</h2><p class="muted-copy">Struk ringkas satu halaman berisi waktu, item, dan total.</p></div><button type="button" class="download-button" :disabled="!isPaid" @click="handleDownloadReceipt"><span aria-hidden="true">↓</span> Download struk</button></section>
      </template>
    </div></main>
    <AppFooter />
